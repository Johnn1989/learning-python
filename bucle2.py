#Funcion para simular los intentos de ingreso de clave en cajero automático
...
def cajero():
    ...
    while status:
        ...
        if my_clave_banco == clave :
            print("Has ingrasado a tu cuenta")
            ...
            if cont_attempts > 3 :
                 print("Se han agotado todos los intentos permitidos.\nTu cuenta ha sido bloqueada")
                 break
